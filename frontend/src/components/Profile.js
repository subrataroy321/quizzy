    ...
    return(
        <div className="profile">
            ...
            <div className="form-field">
                    ...
                    <input id = "name" type = "text" name="name" onChange={handleQuizTitle} value={quizTitle} autoFocus/>
            </div>
            <div>
            ...
            <div style={{backgroundColor: randomColor}}>
                <div id = "allQuestions">
                    <div id="question-field">
                        ...
                        <input className = "question" id = "q1" type = "text" onChange={handleQuestion} value={question} autoFocus/>
                        <br/>
                        <br/>
                        <label>Answer 1: </label>
                        <input id = "1a1" className="answer" type = "text" onChange={handleAnswer1} value={answer1} autoFocus/>
                        <label>Answer 2: </label>
                        <input id = "1a2" className="answer" type = "text" onChange={handleAnswer2} value={answer2} autoFocus/>
                        <br/>
                        <label>Answer 3: </label>
                        <input id = "1a3" className="answer"  type = "text" onChange={handleAnswer3} value={answer3} autoFocus/>
                        <label>Answer 4: </label>
                        <input id = "1a4" className="answer"  type = "text" onChange={handleAnswer4} value={answer4} autoFocus/>
                        <br/>
                        <br/>
                        <label>Correct Answer (1-4) :</label>
                        <input className = "correct" id = "correct1"  type = "number" onChange={handleCorrectAnswer} value={correctAnswer} autoFocus/>
                    </div>
                </div>
